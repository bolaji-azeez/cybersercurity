  ...
  return (
    <div className='h-[100vh] flex w-screen item-center justify-center'>
        ...
        <div className="w-50% flex justify-center items-center p-4 bg-white border border-gray-200  shadow-2xl sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <h5 className="text-[2rem] text-center font-medium text-gray-900 dark:text-white">Log In</h5>
            ...
            <div className="flex items-start">
                ...
                <a href="#" className="ms-auto text-sm text-[#283673] hover:underline dark:text-blue-500">Forgot Password?</a>
            </div>
            <button type="submit" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#283673] dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login to your account</button>
            <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                Not registered? <a href="#" className="text-[#283673] hover:underline dark:text-blue-500">Create account</a>
            </div>
        </form>
</div>
